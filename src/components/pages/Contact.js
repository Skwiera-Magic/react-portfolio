      ...
      <footer class="container">
        <div class="row" id="social">
          ...
          <div class="row col-10">
            <a href="https://github.com/Skwiera-Magic" class="col-6 col-md btn footer-link" target="_blank" rel="noreferrer"><img src="http://icongal.com/gallery/image/374382/github.png" alt="GitHub icon" />GitHub</a>
