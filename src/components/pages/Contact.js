...
function Contact() {
  return (
    <footer class="container bg-light rounded-4 border mt-3">
      ...
      <p className="text-center">If you would like to contact me best place to do that would be: <a class="contact-link" href="mailto:mckskwiera@icloud.com">my email</a></p>
      <p className="text-center">Other ways to contact me can be found here: <a class="contact-link" href="https://www.linkedin.com/in/mskwierawski">linkedIn</a> or <a class="contact-link" href="https://www.twitch.tv/skwiera_magic">Twitch</a></p>
    </footer>
  );
}
